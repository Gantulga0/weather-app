...
const Svg = () => {
  return (
    <div className="absolute inset-0  flex items-center justify-center overflow-hidden underline">
      <div className="absolute w-[140px] h-[140px] border  border-customBorder rounded-full bg-customWhite z-10 flex space-x-4 justify-center items-center bg-white">
        <svg
          width="43"
          height="86"
          viewBox="0 0 43 86"
          ...
          className="absolute z-20 left-[14%]"
        >
          <path
        ...
        <svg
          ...
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
          className="absolute z-20 right-[14%]"
        >
          <path
      ...
      <div className="absolute w-[80px] h-[64px] mt-[180px] ml-[80px]  bg-customWhite flex ">
        <div className=" w-[40px] h-[64px] rounded-tl-full bg-customDark z-20"></div>
      ...
      <div className="absolute w-[140px] h-[140px] border border-customBorder rounded-full bg-white"></div>
      <div className="absolute w-[340px] h-[340px] border border-customBorder rounded-full z-10"></div>
      <div className="absolute w-[540px] h-[540px] border border-customBorder rounded-full z-10"></div>
      <div className="absolute w-[940px] h-[940px] border border-customBorder rounded-full z-10"></div>
      <div className="absolute w-[1340px] h-[1340px] border border-customBorder rounded-full z-10"></div>
    </div>
  );
};
