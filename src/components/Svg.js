  ...
  return (
    <div>
      <svg
        ...
        className="absolute top-[50%] left-[94%] z-20"
      >
      ...
      <svg
        ...
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
        className="absolute top-[50%] left-[94%] z-10"
      >
      ...
      <svg
        ...
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
        className="absolute top-[52%] left-[96%] z-20"
      >
        <path
      ...
      <svg
        ...
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
        className="absolute top-[52%] left-[101%] z-20"
      >
        <path
      ...
      <svg
        ...
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
        className="absolute left-[100%] top-[25px] z-10"
      >
        <path
      ...
      <svg
        ...
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
        className="absolute top-[25px] left-[35%] z-10"
        transform="scale(-1, 1)"
      >
      ...
      <svg
        ...
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
        className="absolute left-[85%] top-[42%] z-10"
      >
